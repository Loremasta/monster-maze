...
00300 D$(4)=" WEST"
00310 REM
00320 DEF FNP(T1) = VAL( SUBSTR( M$(Y1,T1),X1,1) )
00330 REM    POSITION IN STRING ARRAY
00340 DEF FND(X)=ABS(X-23)*ABS(X-19)*ABS(X-5)*ABS(X-14)
...
00540 INPUT A$
00550 IF SUBSTR(A$,1,1)<>"Y" THEN 01440
00560 PRINT
00570 REM
...
01550 INPUT A$
01560 IF SUBSTR(A$,1,1)="N" THEN 01440
01570 REM
01580 X=13
01590 Y=1
01600 D=1
...
01870 IF A(1)=15 THEN 02020
01880 IF A(1)=2 THEN 02950
01890 IF A(1)=4 THEN 02880
01900 IF A(1)=3 THEN 03670
01910 PRINT"   NO SUCH COMMAND"
01920 GOTO 01800
01930 REM
01940 IF A(1)=13 THEN 03060
01950 IF A(1)=3 THEN 03670
01960 IF A(1)=18 THEN 04280
01970 IF A(1)=6 THEN 04550
01980 IF A(1)=4 THEN 02880
01990 PRINT"   NO"
02000 GOTO 01770
02010 REM
...
02730 INPUT A$
02740 PRINT
02750 IF SUBSTR(A$,1,1)<>"Y" THEN 02850
02760 REM
02770 P(8)=P(8)+P(9)
02780 P(9)=0
...
05830 REM
05840 REM DIRECTION
05850 IF A(1)=23 THEN 05980
05860 IF A(1)=19 THEN 05950
05870 IF A(1)=5 THEN 05920
05880 REM
05890 D2=1
05900 RETURN
05910 REM
